...
This analysis containst publicly available Oktoberfest data 1985-2016. The data is available at the [Munich Opendata portal](https://www.opengov-muenchen.de/dataset/oktoberfest/resource/e0f664cf-6dd9-4743-bd2b-81a8b18bd1d2).   
**Disclaimer**: Most of this code was taken from [@gresch's](https://github.com/gresch) [blog post](https://gresch.github.io/2017/09/14/201701oktoberfest1985-2016/). Only the Shiny app was created anew.
...
ggplot(data) + 
  ...
  r_90_d + my_theme
```
[@gresch](https://github.com/gresch) says:
...
ggplot(data) + 
  ...
  r_90_d + my_theme
```
> Not surprisingly, the beer price increased over the years. starting in 1985 with 3.20€ and hitting 10.75€ in 2015. That would be an average yearly increase of 
