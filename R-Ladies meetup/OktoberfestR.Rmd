...
This is a quick analysis of publicly available Oktoberfest data following @[gresch's](https://github.com/gresch) [blog post](https://gresch.github.io/2017/09/14/201701oktoberfest1985-2016), and a Shiny app to go along.

# Setup and data overview
This analysis contains publicly available Oktoberfest data 1985-2016. The data is available at the [Munich Opendata portal](https://www.opengov-muenchen.de/dataset/oktoberfest/resource/e0f664cf-6dd9-4743-bd2b-81a8b18bd1d2).   
**Disclaimer**: Most of this code was taken from @[gresch's](https://github.com/gresch) [blog post](https://gresch.github.io/2017/09/14/201701oktoberfest1985-2016/). Only the Shiny app is to be created anew.
...
Each year is an observation. There are 32 observations and eight variables:
...
@[gresch's](https://github.com/gresch) says:
...
> Not surprisingly, the beer price increased over the years. starting in 1985 with 3.20€ and hitting 10.50€ in 2016. That would be an average yearly increase of 

$(10.57−3.20)/30=0.23774193548387096774193548387097$
...
> The chicken price increased over the years until 1995 to fall slightly. However a huge increase was in the year 2000. The price was increased by 2.47€ more than twelve times the average price increase. Starting in 1985 with 4.77€ and hitting 11.00€ in 2016. That would be an average yearly increase of 

$(11.00−4.77)/31=0.2009677$
...
If you have any feedback on the analysis, the approach or tools, please feel free to contact @[gresch](https://github.com/gresch).
